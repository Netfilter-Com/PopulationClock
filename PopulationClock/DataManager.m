...
- (id)init {
    ...
    NSDictionary *countryNames = @{
        ...
        @"bq" : NSLocalizedString(@"Bonaire, Sint Eustatius Saba", @""),
        ...
        @"va" : NSLocalizedString(@"Holy See (Vatican State)", @""),
        ...
        @"kp" : NSLocalizedString(@"Korea, DPR", @""),
        ...
        @"mk" : NSLocalizedString(@"Macedonia, FYROM", @""),
        ...
        @"fm" : NSLocalizedString(@"Micronesia, FS", @""),
        ...
        @"sh" : NSLocalizedString(@"Saint Helena, Ascension and TC", @""),
        ...
        @"vc" : NSLocalizedString(@"Saint Vincent and Grenadines", @""),
        ...
        @"gs" : NSLocalizedString(@"S Georgia and S Sandwich Isl", @""),
